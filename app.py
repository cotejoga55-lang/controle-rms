...
# Estruturação explícita das abas para isolar completamente o conteúdo de cada uma
if es_admin:
    tab_dash, tab_painel, tab_pend, tab_nova, tab_cons, tab_hist = st.tabs(["📊 Dashboard", "📋 Painel", "📦 Pend. Retirada", "➕ Nova RM", "🔍 Consulta", "📊 Histórico"])
    ...
    tab_painel, tab_pend, tab_cons, tab_hist = st.tabs(["📋 Painel", "📦 Pend. Retirada", "🔍 Consulta", "📊 Histórico"])
